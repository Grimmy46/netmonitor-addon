    ...
    while True:
        try:
            ...
            if not targets:
                time.sleep(30)
                continue
            # Spread pings across 30 seconds
            window   = 30.0
...
<div class="zoom-bar" id="zoom-bar-map" style="display:none;justify-content:space-between;">
  ...
  <div style="display:flex;gap:.5rem;align-items:center;">
    ...
    <div style="position:relative;" id="map-edit-wrap">
      ...
      <div id="map-edit-menu" style="display:none;position:absolute;bottom:calc(100% + 6px);right:0;
  ...
  <div class="page" id="page-map">
    <div class="map-container" id="map-container">
      ...
      <div class="map-sidebar" id="map-sidebar">
        <div class="map-sidebar-hdr">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <button onclick="toggleMapSidebar()" id="map-sidebar-collapse"
              title="Collapse sidebar"
              style="background:none;border:1px solid var(--border);border-radius:4px;color:var(--dim);
              cursor:pointer;font-size:.8rem;padding:.1rem .4rem;line-height:1;">&#9654;</button>
          </div>
      ...
      <div id="map-sidebar-tab" style="display:none;width:24px;background:var(--panel);border-left:1px solid var(--border);
        ...
        <span style="writing-mode:vertical-rl;font-size:.6rem;color:var(--dim);letter-spacing:.1em;">DEVICES</span>
      </div>
    </div>
    <!-- Node tooltip -->
...
async function pingMappedNodes(){
  ...
  for(const key of keys){
    ...
    try{
      const r=await fetch('/ping-device',{method:'POST',
        headers:{'Content-Type':'application/json'},
