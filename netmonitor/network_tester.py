...
<main>
  ...
  <div class="page" id="page-map">
    ...
    <!-- Icon legend -->
    <div style="position:absolute;bottom:.6rem;left:.6rem;background:rgba(5,10,15,.85);border:1px solid var(--border);
      border-radius:8px;padding:.5rem .7rem;display:flex;gap:.9rem;align-items:center;pointer-events:none;z-index:50;">
      <span style="font-family:'Share Tech Mono';font-size:.55rem;color:var(--dim);margin-right:.2rem;">LEGEND</span>
      <span style="color:#00d4ff;font-size:.6rem;display:flex;align-items:center;gap:.3rem;">&#9632; Switch</span>
      <span style="color:#ffd700;font-size:.6rem;display:flex;align-items:center;gap:.3rem;">&#9632; Ticket Box</span>
