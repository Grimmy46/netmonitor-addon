...
/* ── COMPACT LEVELS ── */
body.zoom-xs .test-grid{grid-template-columns:repeat(auto-fill,minmax(175px,1fr));}
...
body.zoom-sm .test-grid{grid-template-columns:repeat(auto-fill,minmax(220px,1fr));}
body.zoom-sm .card{padding:.6rem .7rem;}
body.zoom-sm canvas{height:65px!important;}
body.zoom-lg .test-grid{grid-template-columns:repeat(auto-fill,minmax(340px,1fr));}
body.zoom-lg canvas{height:100px!important;}
body.zoom-xl .test-grid{grid-template-columns:repeat(auto-fill,minmax(420px,1fr));}
